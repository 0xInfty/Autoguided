# This is an adaptation from code found at "WaveMix" by Pranav Jeevan et al
# https://github.com/pranavphoenix/WaveMix/blob/main/wavemix/classification.py under MIT licence
#
# Original copyright disclaimer:
# Copyright (c) 2021 Pranav Jeevan P
